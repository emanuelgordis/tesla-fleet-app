...
The single served file at `https://tesla.trimresearch.com/.well-known/appspecific/com.tesla.3p.public-key.pem` is fetched once by Tesla during partner-account registration.
